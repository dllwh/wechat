...
<table class="layui-hide" id="opLogTable" lay-filter="opLogTableFilter"></table>
...
<script>
	...
	var tableOptions  = {
		...
		cols : [ [
			...
			{ field : 'ipAddress', title : 'IP地址',fixed:'left',minWidth:80},
			{ field : 'opType', title : '描述类型',fixed:'left',minWidth:60},
