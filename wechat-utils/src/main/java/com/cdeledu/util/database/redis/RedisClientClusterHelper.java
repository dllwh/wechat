...
public class RedisClientClusterHelper  implements RedisBasicCommand{
	...
	/** ----------------------------------------------------- Fields end */
	private RedisClientClusterHelper(List<String> hostAndPortList) {
	 ...
	 * @return
	 */
	public static RedisClientClusterHelper getInstance(List<String> hostAndPortList) {
		if (redisClusterFactory == null) {
			redisClusterFactory = new RedisClientClusterHelper(hostAndPortList);
		}
