...
public class ZtreeNode implements Serializable {
	...
	public String toString() {
		return "ZtreeNode [name=" + name + ", checked=" + checked + ", chkDisabled=" + chkDisabled
				+ ", nocheck=" + nocheck + ", open=" + open + ", icon=" + icon + ", iconOpen="
				+ iconOpen + ", iconClose=" + iconClose + ", isHidden=" + isHidden + ", isParent="
				+ IsParent  + ", id=" + id + ", pId=" + pId + ", children=" + children + "]";
	}
}
